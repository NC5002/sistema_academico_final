            ...
            <div class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    <div class="text-center mb-4">
                        <h4 class="text-white">Sistema Académico</h4>
                        <p class="text-white-50">Panel de Profesor</p>
                    </div>
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="profesor_dashboard.php">
                                <i class="bi bi-house-door me-2"></i>
                                Dashboard
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="profesor_cursos.php">
                                <i class="bi bi-book me-2"></i>
                                Mis Cursos
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="profesor_estudiantes.php">
                                <i class="bi bi-people me-2"></i>
                                Estudiantes
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="profesor_calificaciones.php">
                                <i class="bi bi-award me-2"></i>
                                Calificaciones
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="profesor_asistencia.php">
                                <i class="bi bi-calendar-check me-2"></i>
                                Asistencia
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="profesor_tareas.php">
                                <i class="bi bi-clipboard-check me-2"></i>
                                Tareas
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="profesor_materiales.php">
                                <i class="bi bi-file-earmark-text me-2"></i>
                                Materiales
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="profesor_perfil.php">
